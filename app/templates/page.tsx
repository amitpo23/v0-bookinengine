...
const templates = [
  ...
  {
    id: "ai-travel-agent",
    name: "AI Travel Agent Platform",
    description: "פלטפורמת צ'אט מלאה לסוכני נסיעות AI עם בינה מלאכותית, בסיס ידע ומערכת הזמנות משולבת",
    image: "/ai-travel-agent-chat.jpg",
    tags: ["AI", "צ'אט", "נסיעות", "חדש"],
    color: "bg-gradient-to-r from-blue-500 to-purple-600",
    href: "/templates/ai-travel-agent",
    features: ["סוכני AI חכמים", "בסיס ידע מקיף", "צ'אט בזמן אמת", "אינטגרציית הזמנות"],
    isNew: true,
  },
  {
    id: "chatbot-ui",
    name: "ChatBot UI",
    description: "ממשק צ'אט מודרני ופתוח עם עיצוב כהה מושך, מספר שיחות ותמיכה בכל ספקי LLM",
    image: "/chatbot-ui-dark-modern.jpg",
    tags: ["צ'אט", "קוד פתוח", "מודרני", "חדש"],
    color: "bg-gradient-to-r from-slate-900 to-slate-700",
    href: "/templates/chatbot-ui",
    features: ["עיצוב כהה מודרני", "ניהול שיחות", "תמיכה ב-LLM", "קוד פתוח"],
    isNew: true,
  },
  {
    id: "sunday-hotel",
    name: "Sunday Hotels",
    description: "אתר הזמנת מלונות מלא עם חיפוש מתקדם, גלריות תמונות ועיצוב צבעוני ואוורירי",
    image: "/sunday-hotel-colorful.jpg",
    tags: ["מלונות", "צבעוני", "חיפוש", "חדש"],
    color: "bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500",
    href: "/templates/sunday-hotel",
    features: ["חיפוש מתקדם", "גלריות תמונות", "כרטיסי מלונות", "עיצוב אוורירי"],
    isNew: true,
  },
  {
    id: "knowaachat",
    name: "Knowaachat",
    description: "מערכת צ'אט AI חכמה לניהול ידע ותמיכת לקוחות עם ממשק אלגנטי ותכונות ארגוניות",
    image: "/knowaachat-ai-knowledge.jpg",
    tags: ["AI", "ידע", "תמיכה", "חדש"],
    color: "bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600",
    href: "/templates/knowaachat",
    features: ["ניהול ידע חכם", "תמיכה בלקוחות", "AI מתקדם", "אנליטיקה"],
    isNew: true,
  },
]
