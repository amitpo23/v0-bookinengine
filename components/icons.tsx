// Central icon library - replaces lucide-react
// All icons are inline SVGs to avoid bundler issues
...
export const Icons = {
  ...
  copy: (props: IconProps) => (
    ...
    >
      ...
      <path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2v5a2 2 0 0 1-2 2h-2" />
    </svg>
  ),
  eye: (props: IconProps) => (
    <svg
  ...
  bed: (props: IconProps) => (
    ...
    >
      <path d="M2 4v16" />
      <path d="M2 8h18a2 2 0 0 0 2 2v10" />
      <path d="M2 17h20" />
      <path d="M6 8v9" />
    </svg>
  ),
